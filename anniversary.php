...
<section class="heading">
    <h3 class="animate__animated animate__fadeInBottomRight">Anniversary Flowers</h3>
    <p><a href="home.php">home</a> / Anniversary Flowers</p>
</section>
...
<section class="products">
   ...
   <div class="box-container">
      ...
      <?php
         $select_products = mysqli_query($conn, "SELECT * FROM products WHERE type = 'anniversary'") or die('query failed');
